  ...
  return (
    <div className={`px-5 mx-auto my-5 ${styles.formContainer} `}>
      ...
      <div className='d-flex flex-column'>
        <div className='mb-4'>
          <InputGroup label='Email' name='email' validation={validation} placeholder='Nhập email ở đây' />
        </div>
        ...
        <div className={`${styles['input-group-wrapper']}`}>
          ...
          <span className={`${styles['toggle-password']}`} onClick={handleTogglePassword}>
            {showPassword ? <i className='fa-regular fa-eye' /> : <i className='fa-regular fa-eye-slash' />}
          </span>
        </div>
      ...
      >
        <Box sx={style}>
          <div className='d-flex flex-column'>
            ...
            <hr />
            <Typography id='modal-modal-description'>Mật khẩu hoặc email sai rồi, bạn vui lòng nhập lại !</Typography>
      ...
      >
        <Box sx={style}>
          <div className='d-flex flex-column'>
            ...
            <Typography id='modal-modal-description'>Đây chỉ là trang web giả lập thôi nha!</Typography>

            <div className='mt-3'>
              <button className={`btn ${styles.modal__btn}`} onClick={handleContinue}>
                Tham quan 3nime
              </button>
            </div>
          </div>
