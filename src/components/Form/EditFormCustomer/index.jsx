    ...
    <div className='px-5 mx-auto my-5'>
      <div className='d-flex flex-column'>
        <div className='col mb-4'>
          <InputGroup label='Full name' name='fullName' validation={validation} onChange={validation.handleChange} />
        </div>
        ...
        <div className='col mb-4'>
          ...
          <input disabled name='email' value={userData.email} className='form-control' />
        </div>

        <div className='col mb-4'>
          <InputGroup label='Phone' name='phoneNumber' validation={validation} />
        </div>
      ...
      >
        <Box sx={style}>
          <div className='d-flex flex-column'>
            ...
            <hr />
            <Typography id='modal-modal-description'>Editing failed !</Typography>

            <div className='mt-3 d-flex justify-content-center'>
              <button className={`btn ${styles.modal__btn} fs-5 `} onClick={handleClose}>
                Back
              </button>
            </div>
          </div>
