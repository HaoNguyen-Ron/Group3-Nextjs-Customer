...
export default function InputAddress({ name, validation }) {
      ...
      <div className='col-12 col-md-12'>
        <FormControl fullWidth>
          ...
          <Select
            ...
            error={Boolean(validation.touched.city && validation.errors.city)}
          >
            {cityList &&
              cityList.map((city) => (
          ...
          {!isValidCity && <div style={{ color: '#ee2d7a' }}>{validation.errors.city}</div>}
        </FormControl>
      </div>
      ...
      <div className='col-12 col-md-6'>
        <FormControl fullWidth>
          ...
          <Select
            ...
            error={Boolean(validation.touched.district && validation.errors.district)}
          >
            {getCurrentDistrictList() &&
          ...
          {!isValidDistrict && <div style={{ color: '#ee2d7a' }}>{validation.errors.district}</div>}
        </FormControl>
      </div>
      ...
      <div className='col-12 col-md-6'>
        <FormControl fullWidth>
          ...
          <Select
            ...
            error={Boolean(validation.touched.ward && validation.errors.ward)}
          >
          ...
          {!isValidWard && <div style={{ color: '#ee2d7a' }}>{validation.errors.ward}</div>}
        </FormControl>
      </div>
    </div>
  )
