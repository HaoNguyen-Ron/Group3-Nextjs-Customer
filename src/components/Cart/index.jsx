    ...
    <div>
      <div className="container d-flex justify-content-space-between">
        ...
        <figure className={x["snip1278"]}>
          ...
          <div className={x["image"]}>
            <img
              src="https://theme.hstatic.net/1000160337/1000885200/14/categorybanner_2_img.jpg?v=316"
              alt="sq-sample17"
            />
          </div>
          <div className={x["rating"]}>
      ...
      <div className=" container wrapper">
                  ...
                  <div className="owl-stage-outer">
                    <div className="owl-stage">
                      <div
                        ...
                        style={{ width: "190.333px" }}
                      >
                        <div className="row-product">
                          <div className="product-small product-loop">
                            <div
                              className="product-inner product-resize fixheight"
                              style={{ height: 305 }}
                            >
                              <div className="proloop-image ">
                                <div
                                  className="product--image image-resize"
                                  style={{ height: 240 }}
                                >
                                  <div className="product--image__inner">
                                    <div className="prod-img first-image">
                                      <picture>
                                        <img
                                    ...
                                    <div className="prod-img second-image hovered-img hidden-xs hidden-sm">
                                      <picture>
                                        <img
                                          className="img-loop lazyloaded"
                                          alt=" POP UP PARADE Cyberpunk: Edgerunners Rebecca "
                              ...
                              <div className="proloop-detail">
                                ...
                                <p className="proloop--price">
                                  <span className="price">1,600,000₫</span>
                                </p>
                              </div>
        ...
        <div className="layout-content">
          <div className="layout-content__main-half"></div>
          <div className="layout-content__main-half"></div>
        </div>
      </div>
      ...
      <style jsx>
        {`
          ...
          .product-loop
            ...
            .button.btn-proloop-checkout:before {
            background-color: #1e3ea9;
          }
          .product-loop
            .proloop-actions__inner
            .button.btn-proloop-checkout:not(:hover) {
            color: black;
          }
          .product-loop
            .proloop-actions__inner
            ...
            .btnico
            svg {
            fill: color(srgb-linear red green blue);
          }
          ...
          @media (min-width: 992px) {
            .product-loop .proloop-detail {
              background: rgba(225, 230, 231, 0.8);
            ...
            .product-loop:not(.product-horizontal)
              .product-inner:hover
              .proloop-image
              .product--image
              .prod-img.first-image {
