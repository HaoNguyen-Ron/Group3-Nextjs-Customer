...
export default function SearchBarInput({ setQueryResult, searchList, setIsSearched }) {
  ...
  const handleSearchChange = (e) => {
    if (!e.target.value) {
      ...
      const resultsArray = searchList.filter((product) => product.name.match(fuzzy))
  ...
  return (
    <div className='input-group' onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
      ...
      <button
        ...
        style={hover ? { backgroundColor: '#fc629f' } : { backgroundColor: '#ee2d7a' }}
      >
