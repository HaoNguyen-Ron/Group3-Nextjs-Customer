    ...
    <>
        ...
        <div className='container-fluid'>
          ...
          <div className='collapse navbar-collapse' id='navbarSupportedContent'>
            <ul className='navigation-menu navbar-nav me-auto mb-2 mb-lg-0'>
              <NavSidbar title='Trang Chủ' a_href='/' activeTab={activeTab} onClick={onClickTab} />

              <NavSidbar title='Giới Thiệu' activeTab={activeTab} onClick={onClickTab} a_href='/about-us' />
      ...
      <style jsx>
        {`
          ...
          /* NavCaret */
          .navigation-menu > li.active-colors > a:first-child:nth-last-child(2):before {
