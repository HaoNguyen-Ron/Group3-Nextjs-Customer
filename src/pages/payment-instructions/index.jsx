          ...
          <div className='row'>
            <div className={`col-md-9 col-sm-12 col-xs-12`}>
              ...
              <div className={`${pay['payment-content-pc']}`}>
                ...
                <p style={{ textAlign: 'left' }}>Để đặt hàng tại 3NIMEfigure.vn bạn làm như sau:</p>
                ...
                <p style={{ textAlign: 'left' }}>
                  <strong>Bước 3.</strong> Nhập thông tin tên, địa chỉ, sđt, email của bạn.
                </p>
                ...
                <ul>
                  <li style={{ textAlign: 'left' }}>
                    <span style={{ fontSize: '13.3333px' }}>
                      ...
                      hay{' '}
                      <strong>
                        <span style={{ color: 'rgb(255, 0, 0)' }}>ĐẶT TRƯỚC</span>
                      </strong>
                  ...
                  <li style={{ textAlign: 'left' }}>
                    <span style={{ fontSize: '13.3333px' }}>
                      Đơn hàng của bạn sẽ{' '}
                      <strong>
                        <span style={{ color: 'rgb(255, 0, 0)' }}>MẶC ĐỊNH BỊ HỦY NẾU</span>
                      </strong>
                      &nbsp;bạn chọn món{' '}
                      <strong>
                        <span style={{ color: 'rgb(255, 0, 0)' }}>ĐẶT TRƯỚC + COD&nbsp;</span>
                      </strong>
                      <br />
                      <span style={{ color: 'rgb(0, 0, 0)' }}>
                        (Thật vô lý khi yêu cầu giao hàng ngay 1 món đồ ko có sẵn, phải ko ? ^^)
                      </span>
                    </span>
                  </li>
                </ul>
                ...
                <ul>
                  ...
                  <li style={{ textAlign: 'left' }}>
                    <span>
                      ...
                      <strong style={{ color: 'rgb(255, 0, 0)' }}>Đặt trước</strong>.
                    </span>
                  </li>
                </ul>
                    ...
                    <span style={{ color: '#ff0000' }}>
                      <em>
                        <span style={{ textDecoration: 'underline' }}>
                          <Image src='/assets/images/payment-2.jpg' alt='' width={100} height={100} />
                          &nbsp; &nbsp;
                        </span>
                      </em>
                ...
                <p>
                  <br />
                  <span style={{ fontSize: '10pt' }}>Địa Chỉ: Hòa Xuân, Cẩm Lệ, Đà Nẵng</span>
                  <br />
                ...
                <p style={{ textAlign: 'center' }}>
                  <strong>
                    <span style={{ color: '#ff0000' }}>
                      <em>
                        <span style={{ textDecoration: 'underline' }}>
                          <Image src='/assets/images/payment-3.jpg' alt='' width={100} height={100} />
                          &nbsp; &nbsp;
                        </span>
                      </em>
                      <span style={{ fontSize: '12pt', color: '#ff6600' }}>
                ...
                <p>
                  <span style={{ fontSize: '10pt' }}>Với các bạn ở xa có thể gửi vào 1 trong 10 tài khoản sau:</span>
                </p>

                <h2>
                  <span style={{ fontSize: '13.3333px', color: 'rgb(255, 0, 255)' }}>
                    NỘI DUNG CHUYỂN TIỀN LÀ MÃ SỐ ĐƠN HÀNG CỦA BẠN
                    <br />
                    Vd: Cọc 50% cho #0123456 (mã sẽ có sau khi bạn đặt hàng trên web)
                  </span>
                </h2>
                  ...
                  <strong>
                    <span style={{ color: 'rgb(255, 102, 0)' }}>
                      ...
                      <span style={{ fontSize: '12pt' }}>
                        Câu hỏi: Nếu tôi&nbsp;không có tài khoản cá nhân, ko có thẻ?{' '}
                      </span>
                      <br />
                      <span style={{ fontSize: '12pt' }}>
                        Đừng lo lắng, bạn vẫn gửi $ được hoàn toàn bình thường. Cách thức đơn giản như sau:
                      </span>
                    </span>
                  </strong>
                </p>
                ...
                <p>
                  ...
                  <br />
                  <em>#Mã đơn hàng sẽ có sau khi bạn đặt hàng trên web xong.</em>
                </p>
                ...
                <p style={{ textAlign: 'center' }}>
                  <strong>
                    <span style={{ color: 'rgb(255, 102, 0)' }}>
                      ...
                      <br />
                      <span style={{ fontSize: '12pt' }}>
                        Câu hỏi: Tôi muốn chuyển tiền tại nhà, ko cần tới Ngân Hàng?
                      </span>
                    </span>
                  </strong>
                  <br />
                  <span style={{ fontSize: '12pt' }}>
                    <strong>Trả lời: Ok, vậy chỉ cần mở 1 tài khoản ngân hàng là xong.</strong>
                  </span>
                </p>
                <p>
                  <span>
                    ...
                    <br />
                    3. Điền phiếu, ký tên là xong, nhân viên sẽ hướng dẫn bạn cụ thể.
                    <br />
                ...
                <p style={{ textAlign: 'center' }}>
                  <Image src='/assets/images/home.jpg' alt='' width={50} height={50} />
                  &nbsp; &nbsp;
                  <span style={{ fontSize: '12pt' }}>
                    <strong>
                      <span style={{ fontSize: '12pt', color: '#ff6600' }}>
                    ...
                    <strong>
                      <span style={{ color: 'rgb(255, 102, 0)' }}>(chỉ áp dụng cho Hàng có sẵn)</span>
                    </strong>
                  </span>
                </p>
                <p>
                ...
                <p>
                  <span style={{ fontSize: '10pt', color: '#000000' }}>
                    2.Điền đủ thông tin tên họ, địa chỉ, sđt của bạn. Hàng sẽ được giao sau khi&nbsp;có xác nhận từ
                    Japan Figure
                    <br />
                    Thời gian giao hàng từ 1-6 ngày làm việc tùy vào địa chỉ của bạn.
                  </span>
                </p>
                <p>
                  <span style={{ fontSize: '10pt', color: '#000000' }}>
                    3.Nhân viên giao hàng sẽ gọi điện trước khi đến, và chỉ giao hàng khi bạn bắt máy + cho phép họ đến
                    nhà bạn giao hàng.
                  </span>
                </p>
                <p>
                ...
                <p>
                  <span style={{ fontSize: '10pt', color: '#000000' }}>
                    ...
                    <strong>[Hàng Order] , </strong>sau khi hàng về VN, bạn cũng có thể nhận hàng bằng COD bình thường.
                  </span>
                </p>
                <hr />
                <p style={{ textAlign: 'center' }}>
                  <Image src='/assets/images/momo.jpg' alt='' width={50} height={50} />
                  &nbsp; &nbsp;
                  <strong>
                    <span style={{ fontSize: '12pt', color: '#ff6600' }}>Cách 4. Chuyển tiền qua ví điện tử Momo</span>
                  </strong>
                </p>
                <p>
                  <br />
                  <span>
                    ...
                    là ứng dụng tài chính đầu tiên tại Việt Nam cho phép chuyển nhận tiền siêu nhanh qua số điện thoại
                    di động vô cùng tiện lợi. Với những bạn ở xa, khi sử dụng Momo, bạn có thể thực hiện thanh toán với
                    Japan Figure&nbsp;ngay tức khắc.
                  </span>
                  <br />
                  Ứng dụng này tiện dụng đến mức, bạn thậm chí có thể gửi tiền và:
                  <br />
                  <br />
                  <strong>_Không cần chờ đợi Ngân Hàng mở cửa.</strong>
                  <br />
                  <strong>_Không cần đến trực tiếp Ngân Hàng để giao dịch.&nbsp;</strong>
                  <br />
                  &nbsp;
                </p>
                <p>
                ...
                <p style={{ paddingLeft: 30 }}>
                  <strong>
                    <span style={{ color: '#ffffff', backgroundColor: '#cc99ff' }}>
                      <span style={{ fontSize: '10pt' }}>1. Cài đặt app Momo vào smartphone của bạn.</span>
                    </span>
                  </strong>
                </p>
                <p style={{ textAlign: 'left' }}>
                ...
                <p>
                  <span style={{ fontSize: '10pt' }}>
                    A. Đến nạp tiền tại các cửa hàng có giao dịch Momo gần nhà bạn.
                  </span>
                  <br />
                  <span style={{ fontSize: '10pt' }}>B. Nạp từ tài khoản Ngân Hàng liên kết.</span>
                </p>
                <p>
                ...
                <p style={{ paddingLeft: 30 }}>
                  <span style={{ fontSize: '10pt' }}>
                    <span style={{ backgroundColor: '#cc99ff', color: '#ffffff' }}>
                      <strong>4.Trên ứng dụng Momo, bạn vào [Chuyển Tiền]</strong>
                    </span>
                  </span>
                </p>
                <ul>
                  <li style={{ paddingLeft: 30 }}>
                    <span style={{ fontSize: '10pt' }}>Điền sđt người nhận 0908268007. </span>
                  </li>
                  <li style={{ paddingLeft: 30 }}>
                    <span style={{ fontSize: '10pt' }}>
                ...
                <div className='accordion'>
                  <ul className='list-unstyled'>
                    <li>
                      ...
                      <div className='answer'>
                        <ul className='list-unstyled'>
                          <li>
                            <div className='answer'>
                              <p>Có nhiều cách nạp tiền vào Ví MoMo vô cùng đơn giản, nhanh và an toàn.</p>
                              <ul>
                                <li>
                                  <p>
                                    <b>Cách 1: Tại gần 4.000 Điểm giao dịch của MoMo:</b>
                                    Để biết điểm giao dịch gần nhất, vào tính năng <b>Tìm điểm Nạp/Rút tiền</b>trên menu
                                    chính của Ứng dụng.
                                  </p>
                                  <p>
                                    <Image
                                  ...
                                  <p>&nbsp;</p>Đến cửa hàng, bạn hỏi nhân viên/ chủ tiệm là bạn cần nạp tiền vào Momo,
                                  và bạn sẽ được hướng dẫn cụ thể. Nhớ cầm theo CMND nhé.
                                  <p>
                                    <Image
                          ...
                          <li>
                            <p>
                              <b>Cách 2: Nạp tiền với tài khoản/thẻ ngân hàng. Bạn có thể nạp vào từ 3 nguồn sau:</b>
                            </p>
                          </li>
                        </ul>
                        <ul />
                        <p>
                          - Nguồn tiền tử những các tài khoản ngân hàng có liên kết với Ví MoMo (Vietcombank, VPBank,
                          TPBank, OCB, ACB, VietinBank, Eximbank, Sacombank...). Thực hiện liên kết theo hướng dẫn{' '}
                    ...
                    <li>
                      ...
                      <div className='answer'>
                        <p>
                          Để rút tiền khỏi ví, bạn có thể đến bất kỳ Điểm giao dịch nào của MoMo và yêu cầu rút (khi đi
                          nhớ mang theo CMND). Bạn có thể tìm địa chỉ ĐGD khi chọn Điểm Nạp/Rút tại màn hình trong ví
                          MoMo.
                        </p>
                        <p>
                          Ngoài ra, nếu Ví MoMo của bạn đã liên kết với 1 trong 8 ngân hàng sau: Vietcombank, VPBank,
                          TPBank, OCB, ACB, VietinBank, Eximbank, Sacombank (hướng dẫn liên kết
                          <a href='https://momo.vn'>tại đây</a>
                          ), bạn có thể rút bất kỳ lúc nào từ ví MoMo về tài khoản ngân hàng .
                        </p>
                        <p>
                          <Image
                        ...
                        <p style={{ textAlign: 'center' }}>
                          <span style={{ fontSize: '10pt' }}>
                            Email hỗ trợ&nbsp;
                            <a href='mailto:support@3nimefigure.vn'>support@3nimefigure.vn</a>
                            <br />
                ...
                <div className='box-article-tags'>
                  ...
                  <a className={`${pay['tag']}`} href='http://localhost:3000/payment-instructions'>
                    #Hướng dẫn,
                  </a>
                  <a className={`${pay['tag']}`} href='http://localhost:3000/payment-instructions'>
                    #đặt hàng,
            ...
            <div className={`col-md-3 col-sm-12 col-xs-12 mb-5 ${pay['article-post-meta']}`}>
