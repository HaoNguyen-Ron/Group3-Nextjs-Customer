              ...
              <div className='contentAboutusDetail'>
                ...
                <p className='text-justify'>
                  <span style={{ color: '#000' }}>
                    Là mô hình, là tượng, là bất kỳ cách gọi nào liên quan đến những tạo tác 3D cầm nắm được trên tay,
                    mô phỏng lại nhân vật trong bức vẽ, phim, truyện, game... Thông thường figure mang hình dạng con
                    người, đôi khi là động vật, thực vật, quái vật, yêu tinh, thần thánh, thậm chí là sinh vật ngoài
                    tinh...nhân vật nào được điêu khắc thành 3D thì được gọi chung là figure.
                  </span>
                </p>
                ...
                <p style={{ textAlign: 'justify' }}>
                  Với công nghệ của Nhật và quy trình sản xuất được giám sát nghiêm ngặt, những sản phẩm figure được
                  hoàn thành rất có hồn của nhân vật gốc, chi tiết sắc bén, màu sắc sống động, đóng gói hỉnh chu.
                </p>

                <p style={{ textAlign: 'justify' }}>
                  Nhờ đó, figure Nhật Bản&nbsp;đã làm mãn lòng fan hâm mộ trên toàn thế giới.
                </p>

                <h4 className='woo-sc-quote boxed' style={{ textAlign: 'justify' }}>
                  <em>
                ...
                <p style={{ textAlign: 'justify' }}>
                  ...
                  <span style={{ fontSize: 14 }}>
                    <strong>
                      ...
                      >
                        <span style={{ color: '#3333ff' }}>click vào đây để tìm hiểu.</span>
                      </a>
                    </strong>
                  </span>
                </p>
                ...
                <p style={{ textAlign: 'center' }}>
                  <em>Sử dụng Figure để lấp đầy cảm hứng cho không gian làm việc</em>
                </p>
                ...
                <p style={{ textAlign: 'justify' }}>
                  Là nơi chuyên cung cấp figure chính hãng của Nhật Bản tại Việt Nam
                </p>
                ...
                <ul>
                  ...
                  <li style={{ textAlign: 'justify' }}>
                    <span>Giải đáp cho bạn mọi thắc mắc về figure, cách mua hàng, hỗ trợ vận chuyển miễn phí.</span>
                  </li>
                  <li style={{ textAlign: 'justify' }}>
                ...
                <p style={{ textAlign: 'justify' }}>
                  <strong>
                    ...
                    <a href='https://www.facebook.com/groups/japanfigure/'>
                      <span style={{ color: '#3333ff' }}>Sàn Giao Dịch Figure chính hãng -&nbsp;Japan Figure T</span>
                    </a>
                ...
                <p style={{ textAlign: 'justify' }}>
                  <strong>
                    ...
                    <a href='http://japanfigure.vn/pages/lien-he'>
                      <span style={{ color: '#3333ff' }}>Thông tin liên hệ</span>
                    </a>
                  </strong>
                </p>
                <p style={{ textAlign: 'justify' }}>
                  <strong>
                    <span style={{ color: '#3333ff' }}>#</span>
                    <a target='_blank' title='youtube' href='https://www.youtube.com/channel/UCoOXLGsa5joTIO05WF7ZGGA'>
