            ...
            <div className='col-lg-9 col-sm-12 col-xs-12'>
              ...
              <div className='contentAboutusDetail'>
                ...
                <p className='text-justify' style={{ fontSize: '18px' }}>
                  ...
                  Bạn tinvà làm theo? Thì bạn có ít nhất 10-15 triệu/ tháng. <br />
                  Bạn thấy nực cười? Vui lòng lướt qua trong vui vẻ.
                </p>

                <p className='text-justify' style={{ fontSize: '18px' }}>
                  1 người bình thường chỉ kiếm được đúng số $ <br />
                  mà bản thân hình dung được <br />& lên kế hoạch cụ thể ngay từ đầu, không hơn.
                </p>

                <p className='text-justify' style={{ fontSize: '18px' }}>
                  <i>&ldquo;Tôi muốn có được Luffy 1 triệu 4 trong vòng 7 ngày!&rdquo;</i> <br />
                  Ok vậy 1 ngày chỉ cần kiếm 200K là đủ <br />
                  <i>&ldquo;Tôi muốn có được Miku 5 triệu 5 trong vòng 30 ngày!&rdquo;</i> <br />
                ...
                <p className='text-justify' style={{ fontSize: '18px' }}>
                  ...
                  chỉ cần 1 ngày dành ra khoảng <b>1 tiếng kiếm 10đô ~250k là đã đủ rồi </b>
                  <br />
                ...
                <p className='text-justify' style={{ fontSize: '18px' }}>
                  ...
                  thì vui vẻ đóng tab này đi cho đỡ tốn thời gian của bạn. <br />
