          ...
          <div className='col-lg-9 col-sm-12 col-xs-12'>
            ...
            <div className='contentAboutusDetail'>
              ...
              <div className='text-justify fs-25'>
                ...
                <p>
                  Đây là những câu hỏi được rất nhiều bạn quan tâm. Trước tiên, <br />
                  <b>Figure Nhật Bản là những sản phẩm sản xuất HÀNG LOẠT là đúng!</b> <br />
                  Tuy nhiên bạn thừa biết 1 bản nhạc hit bùng lên trong 1 thời điểm rồi cũng đến lúc nhường vị trí xếp
                  hạng <br /> cho 1 hit khác 1 kiểu áo bắt mắt bạn hôm nay rồi cũng bị thay thế bởi 1 kiểu áo khác.{' '}
                  <br />1 nhân vật vạn người mê rồi cũng đến lúc nhường sự chú ý cho 1 nhân vật khác.
                </p>
                ...
                <p>
                  ...
                  Trước tiên,
                  <b>Figure Nhật Bản là những sản phẩm sản xuất HÀNG LOẠT là đúng!</b> <br />
                  Tuy nhiên bạn thừa biết 1 bản nhạc hit bùng lên trong 1 thời điểm rồi cũng đến lúc nhường <br />
                  vị trí xếp hạng cho 1 hit khác 1 <br />
                  kiểu áo bắt mắt bạn hôm nay rồi cũng bị thay thế bởi 1 kiểu áo khác.
                </p>

                <p style={{ color: 'green' }}>
                  Nên là <br />1 hãng thông thường chỉ sản xuất hàng loạt 1 phiên bản <br />
                  của 1 nhân vật trong 1 khoảng thời gian giới hạn <br /> đủ số lượng thị trường cần. <br />
                  <b style={{ color: 'red' }}>
                    &ldquo;Chúng tôi mở bán từ tháng X đến tháng Y Bạn đặt bao nhiêu, hãng làm bấy nhiêu, rồi
                    ngưng.&rdquo;
                  </b>
                </p>
                ...
                <p>
                  ...
                  <b style={{ color: 'red' }}>
                    {' '}
                    Figure Nhật Bản là những sản phẩm sản xuất HÀNG LOẠT với số lượng CÓ HẠN
                  </b>
                </p>

                <p>
                  Với những nhân vật đã qua thời điểm HOT thì có lý do gì để hãng phải sản xuất tiếp? <br />
                  Thay vào đó họ tập trung tạo hình những nhân vật mới, được số đông hưởng ứng, thì doanh thu hàng tháng
                  sẽ đậm đà hơn. <br />
                  Bạn đồng ý chứ? Từ lẽ hiển nhiên này, những figure nào không còn sản xuất nữa, sẽ hiếm dần mỗi ngày,
                  mỗi tháng. <br />
                  <b style={{ color: 'red' }}>
                    VÀ GIÁ CỦA &ldquo;ANH ĐÓ&rdquo;, &ldquo;EM ĐÓ&rdquo;, &ldquo;BÉ ĐÓ&rdquo;, &ldquo;CON FIGURE
                    ĐÓ&rdquo; SẼ TĂNG DẦN THEO THỜI GIAN.
                  </b>
                </p>

                <p>
                  Khi figure bạn thích không còn bán chính thức tại Nhật nữa, <br />
                  <span>
                    không còn cho &ldquo;đặt hàng trước&rdquo; nữa, <br />
                    đồng nghĩa là bạn chỉ có thể sở hữu figure đó bằng cách <br />
                  </span>
                  <b style={{ color: 'green' }}> -mua lại hàng mới từ những người đã nhanh tay đặt hàng từ sớm,</b>{' '}
                  <br />
                  <b style={{ color: 'green' }}>-mua lại hàng cũ từ những người đã sưu tầm,</b> <br />
                  <b style={{ color: 'green' }}> -tranh giành để mua trên sàn đấu giá.</b>
                </p>

                <p>
                  Vậy thì canh mua figure Nhật thế nào để được giá tốt nhất có thể ? <br /> Đọc đến đây thì bạn cũng đã
                  biết câu trả lời rồi: <br />
                  <b style={{ color: 'orange' }}> &ldquo;NGAY THỜI ĐIỂM MỞ BÁN.&rdquo;</b> <br />
                  Sơ đồ dưới đây mô tả lộ trình{' '}
                  <b style={{ color: 'orange' }}>1 figure cầm được trên tay thì mất bao lâu? </b>
                  <br />
                  Hãy theo dõi hãng sản xuất yêu thích của bạn, follow facebook, follow Twitter, Instagram,subscribe
                  Youtube của họ, tiết kiệm và nhanh tay đúng thời điểm, bạn sẽ có nhân vật bạn thích, phiên bản bạn
                  thích với giá tốt nhất!
                </p>
