        ...
        <div className='col-12 col-md-12 col-lg-6'>
          ...
          <div className='userDetail_container ms-3 d-flex flex-column g-2'>
            <div className='userDetail_item text-center'>
              <button onClick={() => setOpenEdit(true)} className={`btn ${styles.user__btn}`}>
            ...
            >
              <Box sx={style}>
                <div className='d-flex flex-column'>
                  <Typography
                    className={`${styles.form__item} d-flex justify-content-between align-items-center`}
          ...
          <div className='mb-4'>
            ...
            <div>
              ...
              {!isValid && <div style={{ color: '#ee2d7a' }}>{validation.errors.paymentType}</div>}
            </div>
          </div>

          <div className='d-flex justify-content-around align-items-center my-5'>
            <button className={` btn`}>
              <Link href={'/cart'} className={styles.user__title}>
                Quay về giỏ hàng
              </Link>
            </button>
      ...
      >
        <Box sx={style}>
          <div className='d-flex flex-column'>
            ...
            <Typography id='modal-modal-description'>Bạn đã giao dịch thành công !</Typography>
      ...
      >
        <Box sx={style}>
          <div className='d-flex flex-column'>
            ...
            <hr />
            <Typography id='modal-modal-description'>Giao dịch thất bại</Typography>
